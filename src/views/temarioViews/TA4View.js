        ...
        <CardBody >
          <Row className="centrado-fila">
            ...
            <Col xs="8" className="text-justify">
              ...
              <p>
                El manejo de objeciones es <b>la habilidad de  identificar  las necesidades del cliente</b> mediante el sondeo,
              de esta manera poder responder a la objeción con un beneficio objetivo y adecuado para el cliente.</p>
            </Col>
          </Row>
        </CardBody>
      </div>
